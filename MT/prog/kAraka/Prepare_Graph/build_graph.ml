...
(* value datapath = sclinstalldir ^ "/MT/prog/kAraka/Prepare_Graph/DATA/";  -- Not needed. Now all these are added in Makefile for compilation *)
...
value no_boundary_crossing_with_iwi id1 id2 text_type =
  if (id1 = iva_pos.val -1) || (id2 = iva_pos.val -1) then True
...
value supAxi_vIpsa id1 cid1 mid1 id2 cid2 mid2 word1 word2 rt1 rt2 vac1 vac2 gen1 gen2 vib1 vib2 rlid =
   let d = if id1 > id2 then id1-id2 else id2-id1 in
   if    id1=previous id2 
   then if  word1=word2
...
value handle_sp_compounds id1 cid1 mid1 id2 cid2 mid2 rt1 word1 pUrvapaxa1 uwwarapaxa1 lifgam1 = 
       ...
       else if (rt1="pUrveNa") (* || (rt1="pramuKeH") Why pramuKa?? vasiRTa-pramuKEH niyujyamAnaH -- not kriyAviSeRaNa*)
...
IVf	D.1      	3           3          		1(gONa) 2       (prayojya karwA is anaBihiwa; hence wqwIyA)
IVg	D.2      	3           3          		2 1(muKya)       (prayojya karwA is anaBihiwa; hence wqwIyA)

*) 
value wifkarwA_karma m1 m2 text_type = match m2 with
  [ Wif (id2,cid2,mid2,word2,rt2,_,_,upasarga2,sanAxiH2,prayogaH2,_,puruRaH2,vacanam2,_,_,_) ->
     match m1 with
     [ WaxXiwa (id1,cid1,mid1,word1,rt1,pUrvapaxa1,uwwarapaxa1,_,lifgam1,viBakwiH1,vacanam1,_)
     | Kqw (id1,cid1,mid1,word1,_,_,_,_,_,_,rt1,pUrvapaxa1,uwwarapaxa1,lifgam1,viBakwiH1,vacanam1,_)
     | Sup (id1,cid1,mid1,word1,rt1,pUrvapaxa1,uwwarapaxa1,lifgam1,viBakwiH1,vacanam1,_) -> 
       ...
       [ 1 ->  if aBihiwa rt1 vacanam1 vacanam2 puruRaH2
           ...
           |"karmaNi" -> let rel = handle_sp_compounds id1 cid1 mid1 id2 cid2 mid2 rt1 word1 pUrvapaxa1 uwwarapaxa1 lifgam1 in
                 ...
                 [ "xvikarmaka1" -> [ Relation (id1,cid1,mid1,"gONakarma",id2,cid2,mid2,"2.3", d)]  
                         (*apraXAne xuhAxinAm.. - gOH xugXaM:gONakarma xuhyawe *)
                 | "xvikarmaka2" -> [ Relation (id1,cid1,mid1,"muKyakarma",id2,cid2,mid2,"2.4", d)]  
           ...
           ["karwari" ->  match sanAxiH2 with
                  [ "Nic" -> match verb_type rt2 upasarga2 with
				     ...
				     if (not (rel=[])) then rel 
		                     ...
		                     then [ Relation (id1,cid1,mid1,"karma",id2,cid2,mid2,"2.12a", d)] 
                                     else [ Relation (id1,cid1,mid1,"prayojyakarwA",id2,cid2,mid2,"2.12", d)]  
				 (* IN the case of 2nd peson, there would not be prayojaka_karwA, and hence directly we call tis relation as karma, so that there is no validity chaekc of presence of prayojaka karwA for  there to be a prayojya karwA *)
		     ...
		     | "gawi"
                ...
                | _ -> if    not (member_of (word1 ^ " " ^ string_of_int viBakwiH1) kriyAviSeRaNas) 
			     ...
			     if (not (rel=[])) then rel 
                             ...
                             then   [ Relation (id1,cid1,mid1,"muKyakarma",id2,cid2,mid2,"2.16a" , d)]
                             else if (lifgam1="napuM") 	(*yogyawA *) (* better condition would be manuRyasaFjFAvAcI/prANivAcI *)
                             then [ Relation (id1,cid1,mid1,"muKyakarma",id2,cid2,mid2,"2.17a" , d)]
			     else [ Relation (id1,cid1,mid1,"gONakarma",id2,cid2,mid2,"2.16" , d)
					...
					It should get karma saFjFA only, as in the case of aXi-SIf-sWAsAM karma *)
				       let rel = handle_sp_compounds id1 cid1 mid1 id2 cid2 mid2 rt1 word1 pUrvapaxa1 uwwarapaxa1 lifgam1 in
			               if (not (rel=[])) then rel 
				       ...
				       then [] (* kim rAmaH gacCawi; here kim is not a karma of gacCawi*)
                                       ...
                                       then if not ((uwwarapaxa1="y") && (rt1 = "pUrvaka"))
    ...
    | 3 ->  match sanAxiH2 with 
        ...
        | _ ->  if (prayogaH2 = "karmaNi" || prayogaH2 = "BAve")
                  && not (member_of word1 kAlAXvas)	 (*yogyawA*)
		  && not (member_of (word1 ^ " " ^ string_of_int viBakwiH1) kriyAviSeRaNas)
...
value rlafgavikAra m1 m2 text_type = match m2 with
   ...
   | Kqw (id2,cid2,mid2,_,_,_,_,_,_,_,rt2,_,_,_,_,_,_)
   | WaxXiwa (id2,cid2,mid2,_,rt2,_,_,_,_,_,_,_) -> 
      match m1 with
      [ Sup (id1,cid1,mid1,_,rt1,_,_,_,viBakwiH1,_,_)
      | Kqw (id1,cid1,mid1,_,_,_,_,_,_,_,rt1,_,_,_,viBakwiH1,_,_)
...
value rl_ca_wif_aBihiwa_karwA_karma m1 m2 m3 text_type = match m2 with
 [ Avy (id2,cid2,mid2,word2,_,_,_,_) -> 
   ...
   [ Wif (id3,cid3,mid3,_,rt3,_,_,upasarga3,sanAxiH3,prayogaH3,_,puruRaH3,vacanam3,_,_,_) ->
     ...
     | Kqw (id1,cid1,mid1,word1,_,_,_,_,_,_,rt1,pUrvapaxa1,uwwarapaxa1,_,viBakwiH1,_,_)
...
But in grAmam gawaH xevaxawwaH puswakaM paTawi, here xevaxawwa should not be marked as karwA of gawaH but gawaH is the viSeRaNa for xevaxawwaH *)
  [ Kqw (id2,cid2,mid2,word2,rt2,upasarga2,sanAxiH2,kqw2,_,_,_,pUrvapaxa2,uwwarapaxa2,lifgam2,viBakwiH2,vacanam2,_) ->
     (* if (uwwarapaxa2="n") then  -- Why this condition? counter example: rAvaNaH kroXa-mUrCiwaH *)
     match m1 with
     [ WaxXiwa (id1,cid1,mid1,word1,rt1,pUrvapaxa1,uwwarapaxa1,_,lifgam1,viBakwiH1,vacanam1,_) 
     | Kqw (id1,cid1,mid1,word1,_,_,_,_,_,_,rt1,pUrvapaxa1,uwwarapaxa1,lifgam1,viBakwiH1,vacanam1,_)
     | Sup (id1,cid1,mid1,word1,rt1,pUrvapaxa1,uwwarapaxa1,lifgam1,viBakwiH1,vacanam1,_) -> 
       ...
       if no_boundary_crossing_with_iwi id1 id2 text_type
        ...
        && d12 < 8
       then if not (sanAxiH2="Nic") && not ((pUrvapaxa2 = "y") && (uwwarapaxa2 = "y"))
...
This condition is added, to rule out the possibility of karwA in Sloka form when kqw precedes the noun as in gawaH rAmaH, or samavewAH pANdavAH, where gawaH and samavewAH should be marked as viSeRaNas and not rAmaH or pANdavAH as karwA *)
			   ...
			   In this sumiwrAnanxa-varXanaH is marked as karma of vinaya-sampannaH, which is wrong *)
                   ...
                   else if    members_of rt2 upasarga2 karmasamAnAXikaraNa_verbs && uwwarapaxa2="n"
                   then [ Relation (id1,cid1,mid1,"karmasamAnAXikaraNam",id2,cid2,mid2,"3.5",d12)
                        ; Relation (id1,cid1,mid1,"muKyakarma",id2,cid2,mid2,"3.6",d12)]  
                           ...
                           || members_of rt2 upasarga2 xvikarmaka2  )  && uwwarapaxa2="n"
...
Ex: hqwAM mEWilIM SqwvA rAmaH vilalApa *)
   			...
   			&& (  members_of rt2 upasarga2 shliR_Axi_verbs
                     ...
                     then [ Relation (id1,cid1,mid1,"karma",id2,cid2,mid2,"3.8",d12)] 
                     else if members_of rt2 upasarga2 gawyarWa_verbs && (uwwarapaxa2 = "n")  (* If it is an uwwarapaxa && kwa, with Tatpurusha, its karma would have been the pUrvapaxa *)
                     then [ Relation (id1,cid1,mid1,"gawikarma",id2,cid2,mid2,"3.8a",d12)]
                     (*else [ Relation (id1,cid1,mid1,"karma",id2,cid2,mid2,"2.8a",d12)]
                     else if (uwwarapaxa1="n") && (pUrvapaxa1="n") 
		     then [ Relation (id1,cid1,mid1,"karma",id2,cid2,mid2,"2.4",d12)] 
Why this condition? 
Counter example: sarva-BUwa-hiwe rawAH *)
                     (*  in case of kwa, if the verb is sakarmaka, the karma will be ukwa. So we need not mark the karma  -- Wrong; Counter example: gqXram nihawam xqRtvA rAGavaH Soka-sanwapwaH *)
                     else if members_of rt2 upasarga2 sakarmaka_verbs && (uwwarapaxa2 = "n")
                     then [ Relation (id1,cid1,mid1,"karma",id2,cid2,mid2,"3.9",d12)]
                     else if members_of rt2 upasarga2 xvikarmaka1 && (uwwarapaxa2 = "n")
                     then [ Relation (id1,cid1,mid1,"gONakarma",id2,cid2,mid2,"3.10",d12)] 
                     else if  members_of rt2 upasarga2 xvikarmaka2 && (uwwarapaxa2 = "n")
                     then [ Relation (id1,cid1,mid1,"muKyakarma",id2,cid2,mid2,"3.10a",d12)] 
                     else []
        ...
        | "ac" -> match viBakwiH1 with
                   ...
                   | 2 -> if (    members_of rt2 upasarga2 sakarmaka_verbs
                          ...
                          then let rel = handle_sp_compounds id1 cid1 mid1 id2 cid2 mid2 rt1 word1 pUrvapaxa1 uwwarapaxa1 lifgam1 in
	                       if (not (rel=[])) then rel 
			       else [ Relation (id1,cid1,mid1,"karma",id2,cid2,mid2,"3.13",d12)] (*rAmaH gqhaM gawavAn*) 
                          else []
                   | _ -> []
                   ]
        | "kwavawu" 
        | "u" -> if not (viBakwiH2=7)
                   ...
                   [ 1 -> if noun_agreement vacanam1 vacanam2 lifgam1 lifgam2
                          && not (member_of rt1 intensifiers_list)
                      then [ Relation (id1,cid1,mid1,"karwA",id2,cid2,mid2,"3.16",d12)] (* aBihiwe karwari praWamA , rAmaH gawavAn *) 
                      else []
                   | 2 -> let rel = handle_sp_compounds id1 cid1 mid1 id2 cid2 mid2 rt1 word1 pUrvapaxa1 uwwarapaxa1 lifgam1 in
	    if (not (rel=[])) then rel 
			  ...
			  then *)
                          [ Relation (id1,cid1,mid1,"karma",id2,cid2,mid2,"3.17",d12)] (*rAmaH gqhaM gawavAn*) 
        ...
        | "yuc"   -> match viBakwiH1 with
                 [ 1 -> if members_of rt2 upasarga2 sakarmaka_verbs && (pUrvapaxa2=uwwarapaxa2|| pUrvapaxa2="a")
                   then [ Relation (id1,cid1,mid1,"karma",id2,cid2,mid2,"3.16a",d12)]  
        ...
        | "Sawq_lqt" ->  if not (viBakwiH2=7) then 
	                 ...
	                 if (not (rel=[])) then rel 
                         ...
                         else if viBakwiH1=1 && word2="san" && not (word1="san")
                         then [ Relation (id1,cid1,mid1,"karwqrahiwakarwqsamAnAXikaraNam",id2,cid2,mid2, "3.19a",d12) ] 
			 else []
                         else if 
	...
	| "lyut" -> match viBakwiH1 with
                    [ 3 -> if members_of rt2 upasarga2 karaNa_verbs
                           then [ Relation (id1,cid1,mid1,"karaNam",id2,cid2,mid2,"3.23",d12) ]
			   else []
                    | 2  ->  if (members_of rt2 upasarga2 sakarmaka_verbs || members_of rt2 upasarga2 xvikarmaka1 || members_of rt2 upasarga2 xvikarmaka2)
                             then [ Relation (id1,cid1,mid1,"karma",id2,cid2,mid2,"3.24",d12)] 
                             else []
                    | _ -> []  (* 6 is covered under kAraka RaRTI*)
                    ]
...
value anaBihiwe m1 m2 id1 cid1 mid1 rt1 word1 pUrvapaxa1 uwwarapaxa1 lifgam1 viBakwiH1 id2 cid2 mid2 rt2 pUrvapaxa2 uwwarapaxa2 upasarga2 kqw1 kqw2 text_type =
   let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
   match viBakwiH1 with
       [ 3 -> if (rt2="yaj1")
                   then [ Relation (id1,cid1,mid1,"karma",id2,cid2,mid2,"4.1",d12)] (* yajeH karmaNaH karaNa saFjFA  vArwika*)
	           else if (rt2 = "yuj2") && (kqw2 = 1)
                        then [ Relation (id1,cid1,mid1,"sahArWaH",id2,cid2,mid2,"4.2a",d12)] 
...
e.g. saH prAwaH BramaNAya gacCawi -- Amruta   14 July 2020
       ...
       | 5 -> if members_of rt2 upasarga2 apAxAna_verbs
             ...
             (* karaNe ca swokAlpakqcCrakawipayasyAsawwvavacanasya 2-3-33 - swokAw mukwaH *)
               ...
               else if word1="wasmAw" && not (pUrvapaxa2 = "y") 
                    then if kqw2=0
                    then [ Relation (id1,cid1,mid1,"kArya_xyowakaH",id2,cid2,mid2,"4.17a",d12)]  
		    else []
                    else if word1="yasmAw"
                         then [ Relation (id1,cid1,mid1,"kAraNa_xyowakaH",id2,cid2,mid2,"4.17b",d12)]  
                         else [ Relation (id1,cid1,mid1,"hewuH5",id2,cid2,mid2,"4.27a",d12) ] (* हेतौ पञ्चमी वा स्यादिस्यर्थः।A bAlamanorama tIkA *)
       ...
       | 7  -> if (upasarga2="aXi" && (rt2="SIf1" || rt2="sWA1"))
               ...
               [  Kqw (id1,cid1,mid1,word1,_,_,_,kqw_prawyayaH1,_,_,rt1,_,_,_,viBakwiH1,_,_) ->
           ...
           if (rt1="brahma" || rt1 = "miwra" || not (lifgam1 = "napuM")) 
            ...
            && kqw1=0 (* the word should not be a kqxanwa to be in samboXana ; this was over-generating in the case of upasafgamya abravIw; upasafgamya being marked as a samboXya *)
             (* if ((lakAraH2="lot") && (puruRaH2="ma"))
              ...
              && (member_of rt1 manuRyasaFjFAvAcI || member_of rt1 upAXi ) 
              && not (pUrvapaxa1="y"|| uwwarapaxa1="y")
 (* These conditions under-generate. In the case of manuRyasaFjFAvAcI, the list needs to be populated. But more importantly, we have various adjectives such as anaGa, etc which are used for samboXana.  But still it is aviable to us this condition, with words such as anaGa etc added to this list, rather than making the list open *)
              then [ Relation (id1,cid1,mid1,"samboXyaH",id2,cid2,mid2,"4.34",d12)]
              else [ ]
           | Kqw (id2,cid2,mid2,_,_,_,_,kqw_prawyayaH2,_,_,_,_,_,_,viBakwiH2,_,_) -> 
           ...
           * || text_type="Sloka")  
-- Here is an example: लोके अस्मिन् द्विविधा निष्ठा पुरा प्रोक्ता मया अन्-अघ  
In order to handle the over-generation, we add a constraint that samboXya can be attached only to the root *)
                 && ((id1 < 2 && text_type = "Prose") || text_type = "Sloka")
                 && (member_of rt1 manuRyasaFjFAvAcI || member_of rt1 upAXi ) 
(* These conditions under-generate. In the case of manuRyasaFjFAvAcI, the list needs to be populated. But more importantly, we have various adjectives such as anaGa, etc which are used for samboXana.  30th dec 2023 *)
               (* && not (pUrvapaxa1="y"|| uwwarapaxa1="y") --
 we need to think about how to allow compound names for samboXya  -- 2nd Aug 2023 *)
...
if (not (lifgam1="napuM") && kqw_prawyayaH2="kwa" || kqw_prawyayaH2="kwavawu" || kqw_prawyayaH2="ac" || kqw_prawyayaH2="yaw") && (viBakwiH2=1) && id2 = total_wrds.val  *)
       ...
       | 2  -> (* covered in rlwifkarwA_karma and rlkqwkarwA_karma *)
           ...
           else if member_of (word1^" "^string_of_int viBakwiH1) kriyAviSeRaNas (* yogyawA *) && lifgam1="napuM" && uwwarapaxa2="n"
  ...
  [ Wif (id2,cid2,mid2,_,rt2,pUrvapaxa2,uwwarapaxa2,upasarga2,_,_,_,_,_,_,_,_) ->
     ...
     | Kqw (id1,cid1,mid1,word1,_,_,_,kqw1,_,_,rt1,pUrvapaxa1,uwwarapaxa1,lifgam1,viBakwiH1,_,_) ->
       if prose_order id1 id2 text_type (* check for leKani etc. *)
         &&  no_boundary_crossing_with_iwi id1 id2 text_type
	 then if ((kqw1 ="Sawq_lat") || (kqw1 = "kwa")) (* In these cases, the kqxanwas can be kaarakas *)
       (*then if (* kqw1="wqc" && *) (viBakwiH1=3 || viBakwiH1 = 5)
Why this condition of 3 & 5 and hewu? We should write this in anaBihiwe itself!
       then [ Relation (id1,cid1,mid1,"hewuH",id2,cid2,mid2,"4.38",d12)] 
       else *) 
       then let kqw1=0 in let kqw2=0 in anaBihiwe m1 m2 id1 cid1 mid1 rt1 word1 pUrvapaxa1 uwwarapaxa1 lifgam1 viBakwiH1 id2 cid2 mid2 rt2 pUrvapaxa2 uwwarapaxa2 upasarga2 kqw1 kqw2 text_type
       else let kqw1=1 in let kqw2=0 in anaBihiwe m1 m2 id1 cid1 mid1 rt1 word1 pUrvapaxa1 uwwarapaxa1 lifgam1 viBakwiH1 id2 cid2 mid2 rt2 pUrvapaxa2 uwwarapaxa2 upasarga2 kqw1 kqw2 text_type
       else []
     | WaxXiwa (id1,cid1,mid1,word1,rt1,pUrvapaxa1,uwwarapaxa1,waxXiwa_prawyayaH1,lifgam1,viBakwiH1,_,_) -> 
       ...
       then [ Relation (id1,cid1,mid1,"hewuH5",id2,cid2,mid2,"4.39",d12)] 
       else let kqw1=0 in let  kqw2=0 in anaBihiwe m1 m2 id1 cid1 mid1 rt1 word1 pUrvapaxa1 uwwarapaxa1 lifgam1 viBakwiH1 id2 cid2 mid2 rt2 pUrvapaxa2 uwwarapaxa2 upasarga2 kqw1 kqw2 text_type
       else []
     | _ -> []
     ]
  | Avykqw (id2,cid2,mid2,_,rt2,pUrvapaxa2,uwwarapaxa2,upasarga2,_,_,_,_) -> 
     match m1 with
     [ Sup (id1,cid1,mid1,word1,rt1,pUrvapaxa1,uwwarapaxa1,lifgam1,viBakwiH1,_,_) ->
       if prose_order id1 id2 text_type
         &&  no_boundary_crossing_with_iwi id1 id2 text_type
...
Why this condition of 3 & 5 and hewu? We should write this in anaBihiwe itself!
     ...
     | WaxXiwa (id1,cid1,mid1,word1,rt1,pUrvapaxa1,uwwarapaxa1,waxXiwa_prawyayaH1,lifgam1,viBakwiH1,_,_) -> 
       ...
       then if  waxXiwa_prawyayaH1="wva" && viBakwiH1=5
       then [ Relation (id1,cid1,mid1,"hewuH5",id2,cid2,mid2,"4.39",d12)] 
       else let kqw1=0 in let  kqw2=1 in anaBihiwe m1 m2 id1 cid1 mid1 rt1 word1 pUrvapaxa1 uwwarapaxa1 lifgam1 viBakwiH1 id2 cid2 mid2 rt2 pUrvapaxa2 uwwarapaxa2 upasarga2 kqw1 kqw2 text_type
       else []
     | _ -> []
     ]
  | Kqw (id2,cid2,mid2,_,rt2,upasarga2,_,kqw2,_,_,_,pUrvapaxa2,uwwarapaxa2,_,viBakwiH2,_,_) ->
       match m1 with
       [ Sup (id1,cid1,mid1,word1,rt1,pUrvapaxa1,uwwarapaxa1,lifgam1,viBakwiH1,_,_)
...
value rlAvykqw_karma m1 m2 text_type = match m2 with
  [ Avykqw (id2,cid2,mid2,_,rt2,_,_,upasarga2,sanAxiH2,_,_,_) -> match m1 with
     [ WaxXiwa (id1,cid1,mid1,word1,rt1,pUrvapaxa1,uwwarapaxa1,_,lifgam1,viBakwiH1,_,_) 
     | Kqw (id1,cid1,mid1,word1,_,_,_,_,_,_,rt1,pUrvapaxa1,uwwarapaxa1,lifgam1,viBakwiH1,_,_)
     | Sup (id1,cid1,mid1,word1,rt1,pUrvapaxa1,uwwarapaxa1,lifgam1,viBakwiH1,_,_) -> 
       let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
       ...
       then match viBakwiH1 with
        [ 2 -> if not (member_of word1 kAlAXvas)
	       ...
	       if (not (rel=[])) then rel 
               ...
               [ "xvikarmaka1" -> if not (lifgam1="napuM")
                                  then 
				  [ Relation (id1,cid1,mid1,"gONakarma",id2,cid2,mid2,"5.1" ,d12)  
              ...
              | "prawyavasAnArWa" -> if not (sanAxiH2="Nic")
                                     then [ Relation (id1,cid1,mid1,"karma",id2,cid2,mid2,"5.3" ,d12)] (* karmaNi xviwIyA *) 
              ...
              | "sakarmaka" -> if not (sanAxiH2="Nic")
                               then if not ((uwwarapaxa1="y") &&  (rt1 = "pUrvaka"))
                               then [ Relation (id1,cid1,mid1,"karma",id2,cid2,mid2,"5.7" ,d12)] (* karmaNi xviwIyA *) 
			       else []
                               else [ Relation (id1,cid1,mid1,"karma",id2,cid2,mid2,"5.8",d12) ]
              | "akarmaka" -> if (sanAxiH2="Nic")
                              then [ Relation (id1,cid1,mid1,"karma",id2,cid2,mid2,"5.9",d12)] 
                              else []
              | _ -> []
              ] 
              else []
        | 3 ->  if (sanAxiH2="Nic")
		then [ Relation (id1,cid1,mid1,"prayojakakarwqrahiwaprayojyakarwA",id2,cid2,mid2,"5.10" ,d12)  ]
		else []
        | _ -> []
        ]
        else []
...
value rlapAxAna_wasil m1 m2 text_type = match m2 with
  ...
  | Kqw (id2,cid2,mid2,_,rt2,upasarga2,_,_,_,_,_,_,_,_,_,_,_) 
  | Avykqw (id2,cid2,mid2,_,rt2,_,_,upasarga2,_,_,_,_) ->
     match m1 with
     ...
     | Avy (id1,cid1,mid1,word1,_,_,uwwarapaxa1,_) -> 
       ...
       then if members_of rt2 upasarga2 apAxAna_verbs
            then [ Relation (id1,cid1,mid1,"apAxAnam",id2,cid2,mid2,"6.4",d12)] 
                 ...
                 then [ Relation (id1,cid1,mid1,"sambanXaH",id2,cid2,mid2,"6.5",d12)]
                 else []
       else []
     |_ -> []
     ]
...
(* saH prajApawi-samaH SrImAn aswi *)
value rlsamAsa_upamAna m1 m2 m3 text_type = match m2 with
   [ Sup (id2,cid2,mid2,word2,rt2,_,uwwarapaxa2,lifgam2,viBakwiH2,vacanam2,_) ->
       if (cid2 > 1) && (uwwarapaxa2 = "y")
       && ((rt2 = "sama") || (rt2 = "saxqSa"))
     then  match m3 with
     [ Sup (id3,cid3,mid3,word3,rt3,_,uwwarapaxa3,lifgam3,viBakwiH3,vacanam3,_) -> 
       let  d23 = if id2 > id3 then id2-id3 else id3-id2 in
       if noun_agreement_vibh vacanam2 vacanam3 lifgam2 lifgam3 viBakwiH2 viBakwiH3
       then  match m1 with
       [ Sup (id1,cid1,mid1,word1,rt1,pUrvapaxa1,_,_,_,_,_) -> 
            if (id1 = id2) && (cid1 = cid2-1)  && (pUrvapaxa1 = "y")
            then [ Relation (id1,cid1,mid1,"upamAnam",id3,cid3,mid3,"18.1a",d23)
                 ; Relation (id2,cid2,mid2,"upamAna_xyowakaH",id1,cid1,mid1,"18.1b",0)
                 ]
            else []
       | _ -> []
       ] else []
...
value rlAvy_kriyAviSeRaNam_or_aXikaraNam m1 m2 text_type = match m2 with
  ...
  | Avykqw (id2,cid2,mid2,word2,_,pUrvapaxa2,uwwarapaxa2,_,_,_,_,_) -> 
     if  pUrvapaxa2="y" || uwwarapaxa2="y" then []
     else match m1 with
     [ Avykqw (id1,cid1,mid1,word1,_,_,uwwarapaxa1,_,_,_,_,_)
     | Avy (id1,cid1,mid1,word1,_,_,uwwarapaxa1,_) -> 
       if prose_order id1 id2 text_type 
       then if word1="yaxA" 
  ...
  | Kqw (id2,cid2,mid2,word2,_,_,_,kqw_prawyaya2,_,_,pUrvapaxa2,uwwarapaxa2,_,_,viBakwiH2,_,_)   ->
     if  pUrvapaxa2="y" || uwwarapaxa2="y" then []
     else if kqw_prawyaya2 ="kwa" || kqw_prawyaya2 ="kwavawu" || kqw_prawyaya2 = "yaw" || kqw_prawyaya2 = "lyut"
    (* kaWam waw jFeyam ? *)
     then match m1 with
     [ Avykqw (id1,cid1,mid1,word1,_,_,uwwarapaxa1,_,_,_,_,_)
     | Avy (id1,cid1,mid1,word1,_,_,uwwarapaxa1,_) -> 
       if prose_order id1 id2 text_type 
       then (*if not (word1="yaxA" )
            then if id2 < waxA_pos.val 
                 then kv_or_spl_aXi id1 cid1 mid1 id2 cid2 mid2 word1  text_type
                 else []
            else This is commented, since this case is covered in  spl_aXikaraNa *) 
            if (viBakwiH2 = 7) && ( id1 > id2) then [] 
            else if (word1="svar") && (word2="gawaH")  (* fixed for svar gawaH ca saH - from Sankshepa RamayaNam *)
            then let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
                 [ Relation (id1,cid1,mid1,"gawikarma",id2,cid2,mid2,"7.1a",d12)]
             (* In case of BavalakRaNa sapwamI, the kriyAviSeRaNa should be to the left of the kqw *)
            else kv_or_spl_aXi id1 cid1 mid1 id2 cid2 mid2 word1 text_type
       else []
     | AvywaxXiwa (id1,cid1,mid1,word1,_,_,uwwarapaxa1,taddhita1,_) -> 
       let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
...
value rlkriyAviSeRaNam_wqwIyA m1 m2 text_type = match m2 with
  ...
  | Avykqw (id2,cid2,mid2,_,_,_,_,_,_,_,_,_) -> 
     match m1 with
     [ WaxXiwa (id1,cid1,mid1,word1,_,_,uwwarapaxa1,_,_,viBakwiH1,_,_) 
     | Kqw (id1,cid1,mid1,word1,_,_,_,_,_,_,_,_,uwwarapaxa1,_,viBakwiH1,_,_)
     | Sup (id1,cid1,mid1,word1,_,_,uwwarapaxa1,_,viBakwiH1,_,_) -> 
       let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
            if (member_of (word1^" "^string_of_int viBakwiH1) kriyAviSeRaNas) (* yogyawA *) (*&& lifgam1="napuM"*)
...
value rl_spl_aXikaraNam m1 m2 text_type = match m2 with
  ...
  | Kqw (id2,cid2,mid2,_,_,_,_,kqw2,_,_,_,pUrvapaxa2,_,_,_,_,_) ->
     if (kqw2 = "anIyar" || kqw2 = "yaw" || kqw2 = "kwa" || kqw2 = "kwavawu"|| kqw2 = "wavyaw" || kqw2 = "lyut") && (pUrvapaxa2="n")
     then match m1 with
     [ Avy (id1,cid1,mid1,word1,_,_,uwwarapaxa1,_) -> 
...
value rlviRayAXikaraNam m1 m2 text_type = match m2 with
   ...
   | WaxXiwa (id2,cid2,mid2,_,rt2,_,_,_,_,_,_,_) -> 
      ...
      | Kqw (id1,cid1,mid1,_,_,_,_,_,_,_,_,_,_,_,viBakwiH1,_,_)
...
value rlpUrvakAla m1 m2 text_type = match m2 with
  [ Wif (id2,cid2,mid2,_,rt2,_,_,_,_,_,_,_,_,_,_,_) ->
     if not (rt2 = "as2") && not (rt2 = "BU1")
     then match m1 with
     [ Avykqw (id1,cid1,mid1,_,_,_,_,_,_,kqw1,_,_) ->
       kwvA_lyap id1 cid1 mid1 id2 cid2 mid2 kqw1 text_type "12.1"
     | _ -> []
     ]
     else []
  | Avykqw (id2,cid2,mid2,_,rt2,_,_,_,_,kqw2,_,_) ->
     if not (rt2 = "as2") && not (rt2 = "BU1")
     then match m1 with
     [ Avykqw (id1,cid1,mid1,_,_,_,_,_,_,kqw1,_,_) ->
   ...
   | Kqw (id2,cid2,mid2,_,_,_,_,kqw_prawyayaH2,_,_,rt2,_,_,_,viBakwiH2,vacanam2,_) ->
     (* if not (viBakwiH2=7) 
...
value wumun id1 cid1 mid1 id2 cid2 mid2 rt2 upasarga2 text_type rl1 rl2 rl3 =
      let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
      if prose_order id1 id2 text_type 
      && no_boundary_crossing_with_iwi id1 id2 text_type
...
value rlwumun1 m1 m2 text_type = match m1 with
  [ Avykqw (id1,cid1,mid1,_,_,_,_,_,_,kqw1,_,_) -> 
    ...
    | Avykqw (id2,cid2,mid2,_,rt2,_,_,upasarga2,_,kqw2,_,_) -> 
         if not (kqw2 = "wumun") then
            wumun id1 cid1 mid1 id2 cid2 mid2 rt2 upasarga2 text_type "13.4" "13.5" "13.6"
         else []
    | Kqw (id2,cid2,mid2,_,rt2,upasarga2,_,_,_,_,_,_,uwwarapaxa2,_,viBakwiH2,_,_) ->
          if not (uwwarapaxa2="y") then
          if members_of rt2 upasarga2 shakAxi
          then if viBakwiH2=1
          then wumun id1 cid1 mid1 id2 cid2 mid2 rt2 upasarga2 text_type "13.7" "13.8" "13.9"
	  else []
          else if  not(viBakwiH2=7) && not(rt2="iR2") 
          then  (* to avoid sawi sapwami cases getting a karma *)
          wumun id1 cid1 mid1 id2 cid2 mid2 rt2 upasarga2 text_type "13.10" "13.11" "13.12"
          else []
          else []
    | _ -> []
    ]
...
value rlwumun2 m1 m2 text_type = match m2 with
  [ Kqw (id2,cid2,mid2,word2,_,_,_,_,_,_,_,rt2,pUrvapaxa2,uwwarapaxa2,_,_,_) 
...
(*
gawaH AsIw -> gawaH can be a karwA. Why do we need sahAyaka kryA?
value rlkwa_as m1 m2 text_type = 
  match m2 with
  [ Wif (id2,cid2,mid2,_,rt2,_,_,_,_,_,_,_,_,_,_,_) ->
     match m1 with
     [ Kqw (id1,cid1,mid1,_,_,_,_,kqw1,_,_,_,_,_,_,_,_,_) ->
      let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
       if    prose_order id1 id2 text_type 
          && rt2="as1" 
          && (kqw1="kwa"|| kqw1="kwavawu") 
          && no_boundary_crossing_with_iwi id1 id2 text_type
       then [ Relation (id2,cid2,mid2,"sahAyakakriyA",id1,cid1,mid1,"15.1",d12)]
       else []
     | _ -> []
     ]
  | _ -> []
...
value rlsamAnakAla m1 m2 text_type = match m1 with
  [ Kqw (id1,cid1,mid1,word1,_,_,_,kqw1,_,_,_,pu1,uw1,_,viBakwiH1,vacanam1,_) -> 
...
(* yogyawA *)
 (* value rlviSeRaNam1 m1 m2 text_type = match m2 with
   ...
   match m1 with
      [ Sup (id1,cid1,mid1,word1,rt1,pUrvapaxa1,uwwarapaxa1,lifgam1,viBakwiH1,vacanam1,_) -> 
           ...
           if no_boundary_crossing_except_kwvA id1 id2 text_type
              ...
              &&  prose_order id1 id2 text_type
	      (* && (not ((rt1="arWa" || rt1 = "ananwaram" || word1 = "sahiwaH" || rt1 = "saxqSa" || rt1 = "saFjASa" || rt1 = "pramuKa" || rt1 = "pUrveNa") && (uwwarapaxa1 = "y")))   Why this condition? Need examples. -- arWa is removed, since waw-arWam karma samAcara is possible. *)
	      && (not ((rt1 = "ananwaram" || word1 = "sahiwaH" || rt1 = "saxqSa" || rt1 = "saFjASa" || rt1 = "pramuKa" || word1 = "pUrveNa") && (uwwarapaxa1 = "y")))  
           then if ( member_of rt1 saMKyeya || member_of rt1 pUraNa || member_of rt1 kqxanwas || member_of rt1 taddhitaantas || member_of rt1 guNavacana  ||member_of rt2 sambanXavAcI
...
(* pronominal12 rt is added to allow a viSeRaNa for asmax such as prapaSxBiH asmaxBiH -- SBG 1.39 *)
	   ...
	   then [ Relation (id1,cid1,mid1,"viSeRaNam",id2,cid2,mid2,"17.1b",d12)]
	   else if pronoun3 rt2 && uwwarapaxa1="y"
	   then [ Relation (id2,cid2,mid2,"viSeRaNam",id1,cid1,mid1,"17.1a",d12)]
	   else if rt2="yuRmax" then [ Relation (id1,cid1,mid1,"viSeRaNam",id2,cid2,mid2,"17.1c",d12)]
	   else if rt1="arWa"  && uwwarapaxa1 = "y" then [ Relation (id1,cid1,mid1,"viSeRaNam",id2,cid2,mid2,"17.1d",d12)] 
      ...
      match m1 with
       [ Sup (id1,cid1,mid1,word1,rt1,pUrvapaxa1,uwwarapaxa1,lifgam1,viBakwiH1,vacanam1,_) -> 
	      ...
	      then if rt2="yuRmax"
              ...
              then [ Relation (id1,cid1,mid1,"aBexaH",id2,cid2,mid2,"17.2",d12)]
              else if rt2="AKyAna" && ((rt1="rAmAyaNa")|| (rt1="mahABarawa") || (rt1 = "SAkunwala"))
              then [ Relation (id1,cid1,mid1,"viSeRaNam",id2,cid2,mid2,"17.3",d12)]
              else if word2="sAkRikam" && uwwarapaxa2="y"
              ...
              then [ Relation (id1,cid1,mid1,"aBexaH",id2,cid2,mid2,"17.5",d12)]
              else [ Relation (id1,cid1,mid1,"viSeRaNam",id2,cid2,mid2,"17.6",d12)]
	      ...
	      then [ Relation (id1,cid1,mid1,"viSeRaNam",id2,cid2,mid2,"17.12",d12)] *)
              else if rt2 = get_assoc rt1 parAjAwi_list  
              then [ Relation (id1,cid1,mid1,"viSeRaNam",id2,cid2,mid2,"17.13",d12)]
              else []
              else []
     | WaxXiwa (id1,cid1,mid1,_,rt1,_,_,_,lifgam1,viBakwiH1,vacanam1,_) -> if (member_of rt1 upAXi) then [] else
       let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
       ...
       && not (finite_verb_in_sentence.val = 50 && karwqsamverbs.val = 50)
        ...
        && not(rt1=rt2) && no_boundary_crossing_except_kwvA id1 id2 text_type
	&& not (rt2 = "kim")
       then [ Relation (id1,cid1,mid1,"viSeRaNam",id2,cid2,mid2,"17.14",d12)]
       else []
     | Kqw (id1,cid1,mid1,_,_,_,_,kqw_prawyayaH1,_,_,rt1,_,_,lifgam1,viBakwiH1,vacanam1,_) -> 
       (* if (member_of rt1 upAXi) then [] else *)
       let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
       if (not (finite_verb_in_sentence.val = 50) || (kqw_prawyayaH1 = "Sawq_lat"))
       (*&& not ( karwqsamverbs.val = 50) -- Why this condition?  -- Otherwise the kwa verb will be marked as a viSeRaNa in examples such as rAmaH grAmam gawaH. But with kqw suffixes such as Sawq_lat, we should allow them as adjectives. Hence the Sawq_lat is added. If other suffixes are also allowed, we need to add them *)
       && no_boundary_crossing_except_kwvA id1 id2 text_type
       && ((viBakwiH1=viBakwiH2 && vacanam1=vacanam2 && niyawalifgam kqw_prawyayaH1)
          || noun_agreement_vibh vacanam1 vacanam2 lifgam1 lifgam2 viBakwiH1 viBakwiH2)
(* When it is Sawq_lat with viB = 1, then it is more likely that it is a kriyAviSeRaNa, linking directly with the wifganwa.
gacCan bAlakaH wqNam spqSawi / bAlakaH gacCan wqNam spqSawi *)
       ...
       && not(rt1=rt2) && not(rt2="kim")
       then if (kqw_prawyayaH1="Sawq_lat") && (viBakwiH1 > 1 && viBakwiH1 < 7) (* vasawi papmAwIre rAmaH; with viBakwiH1=7, vasawi would become an adj of pampAwIre *)
       then [ Relation (id1,cid1,mid1,"viSeRaNam",id2,cid2,mid2,"17.15",d12)]
       else if prose_order id1 id2 text_type
         && not (kqw_prawyayaH1="Sawq_lat")
         && not (kqw_prawyayaH1="lyut")
         && not (kqw_prawyayaH1="wavyaw")
         && not (kqw_prawyayaH1="anIyar")
       then [ Relation (id1,cid1,mid1,"viSeRaNam",id2,cid2,mid2,"17.16",d12)]
       else []
       else []
     | _ -> []
     ]
...
value rlparimANa_viSeRaNam m1 m2 text_type = match m1 with
  ...
  | Kqw (id1,cid1,mid1,word1,_,_,_,_,_,_,rt1,_,uwwarapaxa1,lifgam1,viBakwiH1,vacanam1,_)
...
value rlavy_viSeRaNam m1 m2 text_type = match m2 with
  ...
  | Kqw (id2,cid2,mid2,_,_,_,_,_,_,_,rt2,_,_,lifgam2,viBakwiH2,vacanam2,_)
...
E.g. saH awIva vegena XAvawI / saH awIva sunxaram bAlakam paSyawi *)
     ...
     | Sup (id1,cid1,mid1,_,rt1,_,_,lifgam1,viBakwiH1,vacanam1,_) ->
       ...
       && (noun_agreement_vibh vacanam1 vacanam2 lifgam1 lifgam2 viBakwiH1 viBakwiH2) 
       (* && member_of rt2 guNavacana   --  Once it is intensifier, we need not check if it is a guNavacana or not  - not necessarily ??  mahaw SUlam; here SUlam is not a guNavacana *)
...
value rlsamboXana_xyowakaH m1 m2 text_type = match m2 with
  ...
  | Kqw (id2,cid2,mid2,_,_,_,_,_,_,_,_,_,_,_,viBakwiH2,_,_)
...
value rlnirXAraNam m1 m2 text_type = match m1 with
      [ Sup (id1,cid1,mid1,_,rt1,_,_,lifgam1,viBakwiH1,vacanam1,_)
      | Kqw (id1,cid1,mid1,_,_,_,_,_,_,_,rt1,_,_,lifgam1,viBakwiH1,vacanam1,_)
      | WaxXiwa (id1,cid1,mid1,_,rt1,_,_,_,lifgam1,viBakwiH1,vacanam1,_) ->
        ...
        | Kqw (id2,cid2,mid2,_,_,_,_,_,_,_,rt2,_,_,lifgam2,viBakwiH2,vacanam2,_) ->
           if  ((rt2 = (get_assoc rt1 nirXAraNa_list)) 
                 || ((rt2 = "kiFciw" || rt2="vara" || rt2="SreRTa" || rt2="uwwama" || rt2 = "uwwamA" || rt2 = "SreRTA" (* || rt2="maXya" -- How can maXye be nirXAraNa? *)
...
value rlvIpsA m1 m2 text_type = match m2 with
  ...
  | Kqw (id2,cid2,mid2,word2,_,_,_,_,_,_,rt2,_,uwwarapaxa2,lifgam2,viBakwiH2,vacanam2,_) -> match m1 with
     [ Kqw (id1,cid1,mid1,word1,_,_,_,_,_,_,rt1,_,uwwarapaxa1,lifgam1,viBakwiH1,vacanam1,_) ->
	if not (uwwarapaxa1 = "y") && not (uwwarapaxa2 = "y")
...
value rlupapaxa m1 m2 text_type = match m2 with
   ...
   | Avykqw (id2,cid2,mid2,word2,rt2,_,_,_,_,_,_,_)
   | WaxXiwa (id2,cid2,mid2,word2,rt2,_,_,_,_,_,_,_) ->
      ...
      | WaxXiwa (id1,cid1,mid1,_,rt1,_,_,_,_,viBakwiH1,_,_) ->
       let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
		 ...
		 | "praxakRiNam" -> 
                    [Relation (id1,cid1,mid1,"sanxarBa_binxuH",id2,cid2,mid2,"25.6a",d12)]
                 | _ -> []
                 ]
         | 3  -> match rt2 with
                 [ "samAna" | "samAnA" | "saxqkRa" | 
                   ...
                   "wulya" | "wulyA" | (* "yukwa" | *)  "samA" ->  (* yukwa cannot have wulanA binxu *)
                    [Relation (id2,cid2,mid2,"upamAna_xyowakaH",id1,cid1,mid1,"25.7",d12)]
                 ...
                 | _ -> match rt2 with
                   ...
                   | "aXipawi" | "ISvara"  | "prawiBU" | "sAkRin" | "sAkRiNI" |
                     "xAyAxa" | "svAmin" | "svAminI" ->
                       (*[Relation (id1,cid1,mid1,"aBexaH",id2,cid2,mid2,"25.23",d12)] -- How can it be aBexaH? Should it not be sva-svAmIBAva/RaRTIsambanXaH?  25th Aug 2023 *)
                       [Relation (id1,cid1,mid1,"RaRTIsambanXaH",id2,cid2,mid2,"25.23",d12)]
                   | _ -> []
                   ] 
                 ]
        | 7 -> match rt2 with
     ...
     | Avy (id1,cid1,mid1,word1,rt1,_,_,_) -> 
       let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
	          ...
	          if word2 = "SarmaNe" && (rt1="awra" || rt1 = "wawra" || rt1 = "parawra")
                  then [Relation (id1,cid1,mid1,"kAlAXikaraNam",id2,cid2,mid2,"25.30a",d12)]
		  else []
     | _ -> []
     ]
  |_ -> []
...
value rlupapaxa_other_rel m1 m2 text_type = match m1 with
  ...
  | Kqw (id1,cid1,mid1,word1,_,_,_,_,_,_,rt1,_,_,_,viB1,_,_)
  | WaxXiwa (id1,cid1,mid1,word1,rt1,_,_,_,_,viB1,_,_) ->
   ...
   | Avykqw (id1,cid1,mid1,word1,rt1,_,_,_,_,_,_,_) ->
           match word1 with
          [ "praBqwiH"|
           "aBi" | "anu" | "apa" | (*"api" | -- removed, since it overgenerates. We need to allow this only after examining examples with api *)
            "AraBya" | "A" | "aXi" | "vaRat" |
...
value rlupapaxa_viSeRaNa m1 m2 text_type = match m1 with
  ...
  | Kqw (id1,cid1,mid1,word1,_,_,_,_,_,_,rt1,_,_,lifgam1,viBakwiH1,vacanam1,_)
  | WaxXiwa (id1,cid1,mid1,word1,rt1,_,_,_,lifgam1,viBakwiH1,vacanam1,_) ->
    match word1 with
       [ "sAXu" | "prawIcI" | "hiwam" | "asAXu" |
         ...
         | Kqw (id2,cid2,mid2,word2,_,_,_,_,_,_,rt2,_,_,lifgam2,viBakwiH2,vacanam2,_)
...
value rlRaRTIsambanXaH m1 m2 text_type = match m1 with
      ...
      | Kqw (id1,cid1,mid1,_,rt1,_,_,_,_,_,_,_,_,lifga1,viBakwiH1,vacana1,_)
      | WaxXiwa (id1,cid1,mid1,_,rt1,_,_,_,lifga1,viBakwiH1,vacana1,_) ->
           ...
           then match m2 with 
                 [ Kqw (id2,cid2,mid2,word2,rt2,_,_,kqw2,_,_,_,pUrvapaxa2,uwwarapaxa2,_,viBakwiH2,_,_) -> 
                   let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
		   if   prose_order id1 id2 text_type
                   then if no_boundary_crossing_with_iwi id1 id2 text_type
                        && ((kqw2="GaF" || kqw2="wavyaw" || kqw2="wqc" || kqw2 = "kwin" || kqw2 = "ac" || kqw2="Nvul"))
                         (*|| (kqw2="kwa" && not (viBakwiH2 = 1))  -- Need example for kwa *)
			...
			&& not (pronominal123 rt2)
                   then [ Relation (id1,cid1,mid1,"RaRTIsambanXaH",id2,cid2,mid2,"28.1",d12)]
                   else if   pUrvapaxa2="y"     (* asamartha padavidhi - xevaxawwasya guru-kulam; piwuH vacana-nirxeSAw *)
                   then if   member_of rt2 sambanXavAcI 
                            || word2="hiwa-" 
                            || word2="vacana-"  (* We should add all rUDa kqxanwas here *) (*rAmasya hiwakAmyayA, rAmasya vacanAnusAreNa *)
                             (* asamarWa compound *)
                 ...
                 | WaxXiwa (id2,cid2,mid2,word2,rt2,pUrvapaxa2,uwwarapaxa2,_,_,viBakwiH2,_,_) -> 
       		   let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
			       ...
			       && not (pronominal123 rt2)
                               ...
                               else if (rt2="ayuwa") || (rt2="sahasra")  (* ayuwa = 10 thousand; gavAM ayuwaM thousands of cows *)
                               then [ Relation (id1,cid1,mid1,"RaRTIsambanXaH",id2,cid2,mid2,"28.5a",d12)]
                               else if   pUrvapaxa2="y"     (* asamartha padavidhi - xevaxawwasya guru-kulam; piwuH vacana-nirxeSAw *)
                                    then if   member_of rt2 sambanXavAcI 
                                           || word2="hiwa-" 
                                           || word2="vacana-"  (* We should add all rUDa kqxanwas here *) (*rAmasya hiwakAmyayA, rAmasya vacanAnusAreNa *)
                                              (* asamarWa compound *)
                                           || (not (lifga1="napuM") || (rt1="vyAkaraNa"))
                                         then [ Relation (id1,cid1,mid1,"RaRTIsambanXaH",id2,cid2,mid2,"28.2",d12)]
                                         else []
                                         else if (rt2="vaXa")   (* han1 + ap *)
                                              then [ Relation (id1,cid1,mid1,"RaRTIsambanXaH",id2,cid2,mid2,"28.5a",d12)]
                                              else []
                          else if member_of rt2 viRayi_list
                               then [ Relation (id1,cid1,mid1,"RaRTIsambanXaH",id2,cid2,mid2,"28.6",d12)]
                                    ...
                                    then [ Relation (id1,cid1,mid1,"RaRTIsambanXaH",id2,cid2,mid2,"28.7",d12)]
                                        ...
                                        && not (rt2="jyAyas") (* This has IyasUna suffix, sense of warap is there *)
                                        && not (rt2="jyAyasI") (* This has IyasUna suffix, sense of warap is there *)
                 ...
                 (*| Avykqw (id2,cid2,mid2,word2,_,_,_,_,_,_,_,_)
...
value rl_kAraka_RaRTI1 m1 m2 text_type = match m2 with
  [ Kqw (id2,cid2,mid2,_,kqw_rt2,upasarga2,_,kqw2,_,_,rt2,_,_,_,_,_,_) ->
     match m1 with
     [ Sup (id1,cid1,mid1,_,_,_,_,_,viBakwiH1,_,_)
     | Kqw (id1,cid1,mid1,_,_,_,_,_,_,_,_,_,_,_,viBakwiH1,_,_)
     | WaxXiwa (id1,cid1,mid1,_,_,_,_,_,_,viBakwiH1,_,_) -> 
...
value rl_kAraka_RaRTI2 m1 m2 text_type = match m2 with
  [ Kqw (id2,cid2,mid2,rt2,upasarga2,_,_,kqw2,_,_,_,_,_,_,_,_,_) ->
     match m1 with
     [ Sup (id1,cid1,mid1,_,_,_,_,_,viBakwiH1,_,_)
     | Kqw (id1,cid1,mid1,_,_,_,_,_,_,_,_,_,_,_,viBakwiH1,_,_)
     | WaxXiwa (id1,cid1,mid1,_,_,_,_,_,_,viBakwiH1,_,_) -> 
...
value rl_kAraka_RaRTI3 m1 m2 text_type = match m2 with
  [ Avykqw (id2,cid2,mid2,_,_,_,_,_,_,kqw2,_,_) ->
     match m1 with
     [ Sup (id1,cid1,mid1,_,_,_,_,_,viBakwiH1,_,_)
     | Kqw (id1,cid1,mid1,_,_,_,_,_,_,_,_,_,_,_,viBakwiH1,_,_)
     | WaxXiwa (id1,cid1,mid1,_,_,_,_,_,_,viBakwiH1,_,_) -> 
...
value rlkarwqsamAnAXikaraNam m1 m2 m3 text_type = match m2 with
    [ Sup (id2,cid2,mid2,word2,rt2,_,uwwarapaxa2,lifgam2,viBakwiH2,vacanam2,_) ->
      ...
      guNavacana removed to account for kAkaH kokilaH na Bavawi
      then*)
      match m1 with
      [ Sup (id1,cid1,mid1,word1,rt1,_,_,lifgam1,viBakwiH1,vacanam1,_)
      | Kqw (id1,cid1,mid1,word1,_,_,_,_,_,_,rt1,_,_,lifgam1,viBakwiH1,vacanam1,_)
...
(* || pronominal12 rt1 *)
           ...
           && (not (viBakwiH2=1 && rt2="kim") || (rt2="kim" && viBakwiH1=viBakwiH2 && vacanam1=vacanam2 && lifgam1=lifgam2))
           ...
           (* && prose_order id1 id2 text_type *)
            && (id1 < id2 || rt1="kim" || text_type = "Sloka")
...
(* Bhatti kAavya 1.1 shloka *)
	 && not (member_of rt1 intensifiers_list)
         ...
         && no_boundary_crossing_with_iwi id1 id2 text_type
         && ((id2=1) || (id2 > id1 )) (* The first word can not be a viXeya viSeRaNa, except cases such as samarWaH aswi janaH *)
         && (not(id2=1) || (id1-id2 < 3 )) (* The first word can not be a viXeya viSeRaNa, except cases such as samarWaH aswi janaH *)
	 (* && (id2 = total_wrds.val -1 || id2 = total_wrds.val-2 || text_type = "Sloka") (* -2 to take into account ca/api etc. *) -- we found examples where more than 2 viXeya viSeRaNas are possible. Hence commented *)
...
Consider a sent with X Y v1 v2, where X and Y are karwA and karwAsamAnAXikaraNa w.r.t v1 and not wrt v2. And suppose in the final parse X is karwA of v2, then marking a relation of karwAsamAnAXikaraNa between X and Y will be wrong *)
      ...
      | Avykqw (id3,cid3,mid3,_,rt3,_,_,upasarga3,_,_,_,_) ->
...
Consider a sent with X Y v1 v2, where X and Y are karwA and karwAsamAnAXikaraNa w.r.t v1 and not wrt v2. And suppose in the final parse X is karwA of v2, then marking a relation of karwAsamAnAXikaraNa between X and Y will be wrong *)
      ...
      | Avykqw (id3,cid3,mid3,_,rt3,_,_,upasarga3,_,_,_,_) ->
          if members_of rt3 upasarga3 karwqsamAnAXikaraNa_verbs
	   && not (word2="san")  (* we need to reqrite this adding a condition that the kqw2 is not Sawq_lat *)
           && viBakwiH1=viBakwiH2
           && ((vacanam1=vacanam2) || (rt1="mAsa" && (rt2="xakRiNAyana" || rt2="uwwarAyaNa")))
           && not (member_of rt1 saMKyeya) (* yogyawA *)
           (*&& not (member_of rt1 guNavacana) (* yogyawA *)
...
E.g. grAmasya aXareNa vanam aswi.*)
      ...
      (* else [] *)
  | Kqw (id2,cid2,mid2,_,_,_,_,_,_,_,rt2,_,_,_,viBakwiH2,vacanam2,_)
...
value vikArya rt1 rt2 =
       (rt1="suvarNa" && rt2 = "kuNdala")
   ||  (rt1="mqwwikA" && rt2 = "Gata")
   ||  (rt1="SUrpaNaKA" && rt2 = "virUpiwA")
   ||  ((member_of rt1 manuRyasaFjFAvAcI) && (member_of rt2 guNavacana))
;
...
value rlkarmasamAnAXikaraNam m1 m2 m3 text_type = 
    ...
    [ Sup (id2,cid2,mid2,word2,rt2,pUrvapaxa2,uwwarapaxa2,gen2,viB2,vac2,_) ->
      ...
      | Kqw (id1,cid1,mid1,word1,_,_,_,_,_,_,rt1,_,_,gen1,viB1,vac1,_)
      | WaxXiwa (id1,cid1,mid1,word1,rt1,_,_,_,gen1,viB1,vac1,_) ->
           ...
           then match m3 with 
            [ Kqw (id3,cid3,mid3,_,rt3,upasarga3,_,prawyayaH3,_,_,_,_,_,_,_,_,_)
            | Avykqw (id3,cid3,mid3,_,rt3,_,_,upasarga3,_,prawyayaH3,_,_) ->
               let  d23 = if id2 > id3 then id2-id3 else id3-id2 in
               ...
               then [ Relation (id2,cid2,mid2,"karmasamAnAXikaraNam",id1,cid1,mid1,"35.1",d23) ]
            ...
            | Wif (id3,cid3,mid3,_,rt3,_,_,upasarga3,_,prayogaH3,_,_,_,_,_,_) ->
               ...
               && (vikArya rt1 rt2 || not (rt3="kq3"))
               && prose_order id1 id2 text_type 
               then if    (prayogaH3="karwari" && viB1=2) || ( prayogaH3="karmaNi" && viB1=1)
                    then [ Relation (id2,cid2,mid2,"karmasamAnAXikaraNam",id1,cid1,mid1,"35.2",d23) ]
                    else []
                   (* to avoid kIxqSam vyavahAram as karma, karmasamAnAXikaraNam*)
               else []
            | _ -> []
    ...
    | Avy (id2,cid2,mid2,_,rt2,_,_,_) -> 
        ...
        | Kqw (id1,cid1,mid1,_,_,_,_,_,_,_,rt1,_,_,_,_,_,_)
       ...
       let  d23 = if id2 > id3 then id2-id3 else id3-id2 in
                ...
                then [ Relation (id2,cid2,mid2,"karmasamAnAXikaraNam",id1,cid1,mid1,"35.4",d23) ]
                else []
              | Wif (id3,cid3,mid3,_,rt3,_,_,upasarga3,_,prayogaH3,_,_,_,_,_,_) ->
       let  d23 = if id2 > id3 then id2-id3 else id3-id2 in
                if rt3="kq3" && prose_order id2 id3 text_type && (vikArya rt1 rt2)
                then [ Relation (id2,cid2,mid2,"karmasamAnAXikaraNam",id1,cid1,mid1,"35.5",d23) ]
                else []
              | _ -> []
              ]
              else []
    ...
    | Kqw (id2,cid2,mid2,word2,_,_,_,_,_,_,rt2,pUrvapaxa2,uwwarapaxa2,gen2,viB2,vac2,_)
      ...
      | WaxXiwa (id1,cid1,mid1,word1,rt1,_,_,_,gen1,viB1,vac1,_) ->
       ...
       let  d23 = if id2 > id3 then id2-id3 else id3-id2 in
	    ...
	    if (not (rel=[])) then rel 
                   ...
                   && ((vikArya rt1 rt2) || not (rt3="kq3"))
                   (* to avoid kIxqSam vyavahAram as karma, karmasamAnAXikaraNam*)
            then [ Relation (id2,cid2,mid2,"karmasamAnAXikaraNam",id1,cid1,mid1,"35.6",d23) ]
             (* waxA AyojakAH neharUM sanwuRtaM kqwavanwaH *)
            else []
            | Wif (id3,cid3,mid3,_,rt3,_,_,upasarga3,_,prayogaH3,_,_,_,_,_,_) ->
       let  d23 = if id2 > id3 then id2-id3 else id3-id2 in
            ...
            then if    prayogaH3="karwari" && viB1=2
                   && ((vikArya rt1 rt2) || not (rt3="kq3"))
                 then [ Relation (id2,cid2,mid2,"karmasamAnAXikaraNam",id1,cid1,mid1,"35.7",d23) ]
                 else if prayogaH3="karmaNi" && viB1=1
                   && ((vikArya rt1 rt2) || not (rt3="kq3"))
                 then [ Relation (id2,cid2,mid2,"karmasamAnAXikaraNam",id1,cid1,mid1,"35.8",d23) ]
                 else []
                   (* to avoid kIxqSam vyavahAram as karma, karmasamAnAXikaraNam*)
            else []
            else []
...
value rl_hi m1 m2 m3 text_type = match m1 with
        [ Avy (id1,cid1,mid1,_,rt1,_,_,_) ->
		     ...
		     else if ((id1=id3+1) && (id1 < 4)) 
                     then [ Relation (id1,cid1,mid1,"kAraNa_xyowakaH",id3,cid3,mid3,"50.1",d13)]
		     else
                     match m2 with
                     [ Sup (id2,cid2,mid2,word2,rt2,pUrvapaxa2,uwwarapaxa2,gen2,viB2,vac2,_) ->
                        if id1 < id2 then []
...
value rlsambanXa1 m1 m2 text_type = match m2 with
  [ Avy (id2,cid2,mid2,_,rt2,_,_,_) ->
        ...
        | Avykqw (id1,cid1,mid1,word1,_,_,_,_,_,_,_,_)
        | AvywaxXiwa (id1,cid1,mid1,word1,_,_,_,_,_)
        | Avy (id1,cid1,mid1,word1,_,_,_,_)
    ...
    | Sup (id2,cid2,mid2,word2,rt2,_,_,_,viB2,vac2,_) ->
       ...
       let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
                ...
                then [ Relation (id1,cid1,mid1,"viSeRaNam",id2,cid2,mid2,"27.11",d12)] 
...
value discourse_rel1 m1 id2 cid2 mid2 text_type = match m1 with
     [ Avy (id1,cid1,mid1,word1,_,_,_,_) -> 
       ...
       | "cexapi"
       | "sannapi" -> if (id1 < id2)
                    then [ Relation (id1,cid1,mid1,"vyaBicAra_xyowakaH",id2,cid2,mid2,"37.1",d12)]
                    else []
       | "yawaH" -> if (id1 < id2)
      ...
      (* AvaSyakawA_pariNAma_xyowakaH is at discourse level *)
       | _ -> []
       ]
       else []
     | _ -> []
...
value rlavy_sent_connector m1 m2 text_type = match m2 with
  ...
  | Kqw (id2,cid2,mid2,_,_,_,_,kqw2,_,_,_,_,_,_,viB1,_,_) ->
...
value rlavy_wifkqw_special m1 m2 text_type = match m2 with
  [ Wif (id2,cid2,mid2,_,_,pUrvapaxa2,_,_,_,_,_,_,_,_,_,_) ->
     ...
     | Avykqw (id2,cid2,mid2,_,_,pUrvapaxa2,_,_,_,kqw_prawyayaH2,_,_) ->
     match m1 with
     [ Avy (id1,cid1,mid1,word1,_,_,_,_) -> 
       let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
           if no_boundary_crossing_with_iwi id1 id2 text_type
           ...
           | "nahi" 
           | "na" ->  (*if prose_order id1 id2 text_type this overgenerates; e.g. virakwaH awra na hqRyawi na kupyawi*)
		      if (id1 < id2) && (pUrvapaxa2="n") && not (kqw_prawyayaH2="wumun")
                      then [ Relation (id1,cid1,mid1,"prawiReXaH",id2,cid2,mid2,"38.7",d12)]
                      else []
           | "kacciw" | "Sam" | "svaswi" | "svAhA" | "svaXA" | "vaRat" | "namaH"
           | "kim" ->  if id1 = total_wrds.val 
                       then [ Relation (id1,cid1,mid1,"sambanXaH",id2,cid2,mid2,"38.8",d12)]
                       else if  id1 < id2 
                            then if not (id1 = 1) && id2 = id1+1
                                 then [ Relation (id1,cid1,mid1,"prayojanam1",id2,cid2,mid2,"38.9",d12)]
                                 else [ Relation (id1,cid1,mid1,"prayojanam1",id2,cid2,mid2,"38.10",d12)
                                      ; Relation (id1,cid1,mid1,"sambanXaH",id2,cid2,mid2,"38.11",d12)
                                      ]
                            else []
          | "waw" ->  if prose_order id1 id2 text_type
                      then [ Relation (id1,cid1,mid1,"sambanXaH",id2,cid2,mid2,"38.12",d12)]
                      else []
          | _ -> []
          ]
          else []
	...
	if (kqw_prawyayaH2="kwa" || kqw_prawyayaH2="kwavawu" || kqw_prawyayaH2="yaw" || kqw_prawyayaH2 = "anIyar") && (finite_verb_in_sentence.val == 50)
        ...
        [ Avy (id1,cid1,mid1,word1,_,_,_,_) -> 
           let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
              ...
              | "nahi" 
              | "na" ->  (*if prose_order id1 id2 text_type this overgenerates; e.g. virakwaH awra na hqRyawi na kupyawi*)
		      if (id1 < id2) && (pUrvapaxa2="n") && (uwwarapaxa2="n")
                      then [ Relation (id1,cid1,mid1,"prawiReXaH",id2,cid2,mid2,"38.13",d12)]
                      else []
              | "kacciw" | "Sam" | "svaswi" | "svAhA" | "svaXA" | "vaRat" | "namaH"
              | "kim" ->  if id1 = total_wrds.val 
                       then [ Relation (id1,cid1,mid1,"sambanXaH",id2,cid2,mid2,"38.14",d12)]
                       else if  id1 < id2 
                            then if not (id1 = 1) && id2 = id1+1
                                 then [ Relation (id1,cid1,mid1,"prayojanam1",id2,cid2,mid2,"38.15",d12)]
                                 else [ Relation (id1,cid1,mid1,"prayojanam1",id2,cid2,mid2,"38.16",d12)
                                      ; Relation (id1,cid1,mid1,"sambanXaH",id2,cid2,mid2,"38.17",d12)
                                      ]
                            else []
                   (* kim wvam paTasi -> yes/no, prayojanam     29.5,29.6
                    * kim wvam saMskqwam paTasi -> yes/no, prayojanam 29.5, 29.6
                    ...
                    * wvam paTasi kim -> yes/no  29.3 *)
          | "waw" ->  if prose_order id1 id2 text_type
                      then [ Relation (id1,cid1,mid1,"sambanXaH",id2,cid2,mid2,"38.18",d12)]
                      else []
          | _ -> []
          ]
          else []
...
(* ikRvAku vaMSaH praBavaH rAmaH nAm janEH SruwaH *)
       ...
       | WaxXiwa (id1,cid1,mid1,_,rt1,_,_,_,lifgam1,viBakwiH1,_,_) ->   
        I doubt if kqw or waxXiwa can be saFjFAs  I also think that we should check these names in the list of NERs  and they should be declared as sups *)
                    ...
                    then if id1=previous id2 && word2="nAma" && viBakwiH1=viBakwiH3
                         then [ Relation (id1,cid1,mid1,"saFjFA",id3,cid3,mid3,"39.2",d13)
                              ...
                              then if (id1=previous id2) && vacanam3="eka" 
                                   ...
                                   else -- This case is valid only if the word next to iwi is sanfKyA *) []
                              else []
                    else []
                else []
              | _ -> []
...
value rl_saha_vinA_kqwe m1 m2 m3 text_type = match m3 with
  ...
  | Kqw (id3,cid3,mid3,word3,rt3,upasarga3,_,_,_,_,_,_,_,_,_,_,_)
  | Avykqw (id3,cid3,mid3,word3,rt3,_,_,upasarga3,_,_,_,_) -> match m1 with
       ...
       let  d13 = if id1 > id3 then id1-id3 else id3-id1 in
             match viBakwiH1 with
             [ 3 -> if rt3="gam1" && upasarga3 = "sam_Af" then [ Relation (id1,cid1,mid1,"sahArWaH",id3,cid3,mid3,"40.1",d13)]
                    else if rt3="gam1" && upasarga3 = "sam" then [ Relation (id1,cid1,mid1,"sahArWaH",id3,cid3,mid3,"40.1",d13)]
                    else if rt3="yuj2" && word3 = "yukwaH" then [ Relation (id1,cid1,mid1,"sahArWaH",id3,cid3,mid3,"40.1",d13)]
                    else match m2 with
                [ Avy (id2,cid2,mid2,word2,_,_,_,_) -> 
                   let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
                    match word2 with
          ...
          if not (word1="iwi") then []
             ...
             [ Sup (id2,cid2,mid2,_,rt2,_,_,_,_,_,_) ->
                if not (safKyA rt2) then []
                 ...
                 | Kqw (id3,cid3,mid3,_,_,_,_,_,_,_,rt3,_,_,_,_,vacanam3,_)
                 | WaxXiwa (id3,cid3,mid3,_,rt3,_,_,_,_,_,vacanam3,_) ->  
       let  d13 = if id1 > id3 then id1-id3 else id3-id1 in
                      if vacanam3="bahu" then
                      [Relation (id1,cid1,mid1,"Gataka_xyowakaH",id3,cid3,mid3,"40.9",d13)] 
                      else []
                 | _ -> []
                 ]
             | _ -> []
      ...
      [ Avy (id1,cid1,mid1,word1,_,_,_,_) -> 
       ...
       let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
               ...
               then [ Relation (id1,cid1,mid1,"karma",id2,cid2,mid2,"40.7",d12) ]
                       ...
                       && rt2="vac1" &&  word1="evam" 
                    then  [ Relation (id1,cid1,mid1,"gONakarma",id2,cid2,mid2,"40.10",d12) ]
               else [] 
               else []
            | _ -> []
            ]
...
value rlBAvalakRaNa_sapwamI1 m1 m2 m3 text_type = match m3 with
  [ Kqw (id3,cid3,mid3,_,rt3,upasarga3,_,kqw3,_,_,_,_,_,lifgam3,viBakwiH3,_,_) -> 
      if  (kqw3="Sawq_lat" || kqw3="SAnac_lat" || kqw3="kwa" || kqw3="kwavawu" || kqw3="Sawq_lqt" || kqw3="SAnac_lqt")
       && ((viBakwiH3=7  && lifgam3="puM")
        ...
        || viBakwiH3 = 6)  (*--> This results in over generation. Hence commented
     ...
     then match m1 with
       [ Sup (id1,cid1,mid1,_,_,_,_,_,viBakwiH1,_,_) ->
          ...
          then let karwA_karma =
                   if (viBakwiH1=7 || viBakwiH1=6) && ((id1 < id3) || (id1=id3+1) || (id1=id3+2)) (* in the case of intervening particles such as wu *)
                   then  if  (kqw3="Sawq_lat" || kqw3="SAnac_lat" || kqw3="kwa" || kqw3="kwavawu") 
                         then "BkarwA"
			 else ""
                   else if viBakwiH1=2  && ((id1 < id3) || (id1=id3+1) || (id1=id3+2)) (* अष्ट-अङ्ग-सङ्ग्रहे ज्ञाते वृथा प्राक्-तन्त्रयोः श्रमः भवति *) (* in the case of intervening particles such as wu *)
                   ...
                   then "Bkarma"
                    ...
                    in match m2 with
                       ...
                       | Kqw (id2,cid2,mid2,_,rt2,_,_,kqw2,_,_,_,_,_,_,viBakwiH2,_,_) ->
...
value rlBAvalakRaNa_sapwamI2 m1 m2 text_type = match m2 with
    [ Kqw (id2,cid2,mid2,_,rt2,upasarga2,_,kqw2,_,_,_,_,_,_,viBakwiH2,_,_) ->
       match m1 with
       [ Sup (id1,cid1,mid1,_,_,_,_,_,viBakwiH1,_,_) ->
       let  d12 = if id1 > id2 then id1-id2 else id2-id1 in
     if  prose_order id1 id2 text_type 
...
value rlvAkyakarma m1 m2 m3 text_type = match m2 with
      [ Avy (id2,cid2,mid2,word2,_,_,_,_) ->
           ...
           | Avykqw (id3,cid3,mid3,_,rt3,_,_,upasarga3,_,_,_,_) ->
            ...
            (*| Avykqw (id1,cid1,mid1,_,rt1,_,_,_,_,_)  
           ...
           | Sup (id3,cid3,mid3,word3,rt3,_,_,_,_,_,_) -> 
                 ...
                 [ Wif (id1,cid1,mid1,_,_,_,_,_,_,_,_,_,_,_,_,_)
                 | Kqw (id1,cid1,mid1,_,_,_,_,_,_,_,_,_,_,_,_,_,_) ->
                    if id1 = previous id2 
                    then vAkyakarma_iwi id1 id2 id3 cid1 cid2 cid3 mid1 mid2 mid3 text_type "45.7" "45.8"
                    else []
                 | _ -> []
                 ]
                 else []
...
value vAkyakarma_sub m1 m2 id3 cid3 mid3 text_type rl1 rl2 rl3 rl4 =
           ...
           [ Avy (id2,cid2,mid2,word2,_,_,_,_) ->
             ...
             [ Wif (id1,cid1,mid1,_,rt1,_,_,upasarga1,_,_,_,_,_,_,_,_) ->
                 (*| Kqw (id1,cid1,mid1,_,rt1,upasarga1,_,_,_,_,_,_,_,_,_,_,_)
                   | Avykqw (id1,cid1,mid1,_,rt1,_,_,upasarga1,_,_,_,__) ->
             ...
             | Kqw (id1,cid1,mid1,_,rt1,upasarga1,_,kqw_prawyayaH1,_,_,_,_,_,_,_,_,_) -> 
...
value rlvAkyakarma1 m1 m2 m3 text_type = match m3 with
       ...
       | Kqw (id3,cid3,mid3,_,rt3,_,_,kqw_prawyayaH3,_,_,_,_,_,_,_,_,_) -> 
...
value rl_avaXiH m1 m2 text_type = match m1 with
     [ Avy (id1,cid1,mid1,word1,_,_,_,_) -> match m2 with
       [ Wif (id2,cid2,mid2,_,_,_,_,_,_,_,_,_,_,_,_,_) -> 
         let d12 = if id1 > id2 then id1-id2 else id2-id1 in
              if    id1 < id2  && (word1="yAvaw" || word1="wAvaw" || word1 = "ewAvaw")
...
value rlsent_connectives m1 m2 m3 text_type = match m2 with
     [ Avy (id2,cid2,mid2,word2,_,_,_,_) -> match m3 with
       [ Wif (id3,cid3,mid3,_,_,_,_,_,_,_,_,_,_,_,_,_) -> match m1 with
         ...
         | Kqw (id1,cid1,mid1,word1,rt1,upasarga1,_,kqw1,_,_,_,_,uwwarapaxa1,_,_,_,_) ->
       ...
       | Kqw (id3,cid3,mid3,word3,_,_,_,kqw3,_,_,_,_,uwwarapaxa3,_,_,_,_) -> match m1 with
         [ Wif (id1,cid1,mid1,_,rt1,_,_,upasarga1,_,_,_,_,_,_,_,_)  ->
...
value mark_upamAna id1 cid1 mid1 id2 cid2 mid2 id3 cid3 mid3 rl1 rl2 =
         ...
         let d23 = if id2 > id3 then id2-id3 else id3-id2 in
         let d13 = if id1 > id3 then id1-id3 else id3-id1 in
         if (d12 > 4) || (d23 > 4) then []  (* the upamAna cannot be far away from the upamAna xyowaka *)
         else if  (id1 < id2) && (id2 < id3)  (* A iva B *)
...
(* saH aBigawaH saxBiH samuxraH iva sinXuBiH *)
            ...
            then [ Relation (id3,cid3,mid3,"upamAnam",id1,cid1,mid1,"93",d13)
                 ; Relation (id2,cid2,mid2,"upamAna_xyowakaH",id3,cid3,mid3,"94",d12)
                 ]
            else [ Relation (id3,cid3,mid3,"upamAnam",id1,cid1,mid1,"95",d13)]
      else if  id1 < id2 && id3 < id2 (* B A iva *)
           then  if  d12 > d23 
                 then  if id2 = next id3 
                   then [ Relation (id3,cid3,mid3,"upamAnam",id1,cid1,mid1,"96",d13)
                        ; Relation (id2,cid2,mid2,"upamAna_xyowakaH",id3,cid3,mid3,"97",d12)
                        ]
		   else if id2-id3 < 5 (* To ensure that the upamAna is not far away from iva *)
                   then [ Relation (id3,cid3,mid3,"upamAnam",id1,cid1,mid1,"98",d13)]
		   else []
                 else if  d23 > d12 
                  then  if id2 = next id1 
                        then [ Relation (id1,cid1,mid1,"upamAnam",id3,cid3,mid3,"99",d13)
                             ; Relation (id2,cid2,mid2,"upamAna_xyowakaH",id1,cid1,mid1,"100",d12)
                             ]
		        else if id2-id1 < 5 (* To ensure that the upamAna is not far away from iva *)
                        then [ Relation (id1,cid1,mid1,"upamAnam",id3,cid3,mid3,"101",d13)]
		        else []
	          else []
	  else []
;
...
value rlupamAna_upameya_sup m1 m2 m3 text_type = match m2 with
     [ Avy (id2,cid2,mid2,word2,_,_,_,_) -> 
        if word2 = "iva" || word2 = "yaWA" then match m3 with
        [ Sup (id3,cid3,mid3,_,rt3,_,uwwarapaxa3,_,viBakwiH3,_,_)
        | WaxXiwa (id3,cid3,mid3,_,rt3,_,_,uwwarapaxa3,_,viBakwiH3,_,_) ->   (* saH himavAn iva *)
        (*| Kqw (id3,cid3,mid3,_,_,_,_,_,_,_,_,_,_,_,_,viBakwiH3,_,_) *)
               ...
               if not (member_of rt3 guNavacana) 
                ...
                && not (member_of rt3 upAXi) (*|| uwwarapaxa3="y" -- compound is allowed: xeva-mAyA iva nirmiwA sarva-lakRaNa-sampannA *)
             ...
             | WaxXiwa (id1,cid1,mid1,_,rt1,_,_,uwwarapaxa1,_,viBakwiH1,_,_) ->  (* saH himavAn iva *)
                   if viBakwiH1=viBakwiH3 (* || viBakwiH3 = 1 *)
                     ...
                     && not (member_of rt1 upAXi) 
                     && not (member_of rt1 manuRyasaFjFAvAcI) *)
                     && not (member_of rt1 upAXi) (* || uwwarapaxa1="y"  -- compound is allowed: xeva-mAyA iva nirmiwA sarva-lakRaNa-sampannA *)
             ...
             (*| Kqw (id1,cid1,mid1,_,rt1,_,_,_,_,_,_,_,_,_,_,viBakwiH1,_,_) ->
                   (* && id2 < id3 aSmanA iva nirmiwaM xuRtAnAm hqxayam  *) 
        ...
        | Wif (id3,cid3,mid3,_,_,_,_,_,_,_,_,_,_,_,_,_) -> 
	     if (id3 = id2-1) 
             then [ Relation (id2,cid2,mid2,"uwprekRA_xyowakaH",id3,cid3,mid3,"50.4",1)]
             else
             match m1 with
             [ Wif (id1,cid1,mid1,_,_,_,_,_,_,_,_,_,_,_,_,_) ->
                   if id2 < id3
     ...
     | Sup (id2,cid2,mid2,_,rt2,_,uwwarapaxa2,_,viBakwiH2,_,_) ->
         match rt2 with
         [ "samAna" | "samAnA" | "saxqkRa" | 
           "saxqkRA" | "saxqkRI" | "saxqSA" | "saxqSa" | "saxqS" | 
           "wulya" | "wulyA" | "samA" -> match m3 with
           [ Sup (id3,cid3,mid3,_,rt3,_,uwwarapaxa3,_,viBakwiH3,_,_)
           | WaxXiwa (id3,cid3,mid3,_,rt3,_,_,uwwarapaxa3,_,viBakwiH3,_,_) ->   
               if not (member_of rt3 guNavacana) 
                && (not (member_of rt3 upAXi) || uwwarapaxa3="y")
                &&  not ( member_of rt3 saMKyeya || member_of rt3 pUraNa || member_of rt3 kqxanwas || member_of rt3 taddhitaantas || member_of rt3 guNavacana) then
               match m1 with
               [ Sup (id1,cid1,mid1,_,rt1,_,uwwarapaxa1,_,viBakwiH1,_,_)
               | WaxXiwa (id1,cid1,mid1,_,rt1,_,_,uwwarapaxa1,_,viBakwiH1,_,_) ->  
                   if viBakwiH3=1  && viBakwiH1=3
                      &&  not (member_of rt1 guNavacana) 
                     && (not (member_of rt1 upAXi) || uwwarapaxa1="y")
                     && not ( member_of rt1 saMKyeya || member_of rt1 pUraNa || member_of rt1 kqxanwas || member_of rt1 taddhitaantas || member_of rt1 guNavacana)
                   then mark_upamAna id1 cid1 mid1 id2 cid2 mid2 id3 cid3 mid3 "50.9" "50.10"
                   else []
               | _ -> []
               ] else []
            | _ -> []
...
value rl_wulanA_binxu m2 m3 text_type viB1 id1 cid1 mid1 rl1 =
       match m2 with
       [ Kqw (id2,cid2,mid2,_,_,_,_,_,_,_,_,_,_,_,viB2,_,_)
...
value rl_wulanA m1 m2 m3 text_type = match m1 with
   [ WaxXiwa (id1,cid1,mid1,_,_,_,_,wax_prawyayaH,_,viB1,_,_) -> 
       ...
       then  rl_wulanA_binxu m2 m3 text_type viB1  id1 cid1 mid1 "56.1"
       else []
    ...
    let d13 = if id1 > id3 then id1-id3 else id3-id1 in
     ...
     | "yaxi"	-> if (id2 < id1) && ((id1 < id3) || (id3 < id2))
                   then [ Relation (id1,cid1,mid1,"AvaSyakawA_pariNAma_sambanXaH",id3,cid3,mid3,"57.2",d13)
                        ; Relation (id2,cid2,mid2,"AvaSyakawA_xyowakaH",id1,cid1,mid1,"57.3",d12)
                        ]
                   else if (id2 < id3) && ((id3 < id1 ) || (id1 < id2))
                   then [ Relation (id3,cid3,mid3,"AvaSyakawA_pariNAma_sambanXaH",id1,cid1,mid1,"57.3",d13)
                        ; Relation (id2,cid2,mid2,"AvaSyakawA_xyowakaH",id3,cid3,mid3,"57.4",d23)
                        ]
		   else []
     | "warhi" ->  if (id2 < id1) && ((id3 < id2 ) || (id1 < id3))
                   then [ Relation (id3,cid3,mid3,"AvaSyakawA_pariNAma_sambanXaH",id1,cid1,mid1,"57.5",d13)
                        ; Relation (id2,cid2,mid2,"pariNAma_xyowakaH",id1,cid1,mid1,"57.6",d12)
                        ]
                   else if (id2 < id3) && ((id1 < id2 ) || (id3 < id1))
                   then [ Relation (id1,cid1,mid1,"AvaSyakawA_pariNAma_sambanXaH",id3,cid3,mid3,"57.7",d13)
                        ; Relation (id2,cid2,mid2,"pariNAma_xyowakaH",id3,cid3,mid3,"57.8",d23)
                        ]
		   else []
     | "yaw"  
     | "yawaH"  ->  (*if (id2 < id1) *) 
		  if (id2 = id3+1) then
                  [ Relation (id1,cid1,mid1,"kArya_kAraNa_BAvaH",id3,cid3,mid3,"57.9",d13)
                  ; Relation (id2,cid2,mid2,"kAraNa_xyowakaH",id1,cid1,mid1,"57.10",d23)
                  ] 
                  else if (id2 = id1+1) then
                  [ Relation (id3,cid3,mid3,"kArya_kAraNa_BAvaH",id1,cid1,mid1,"57.11",d13)
                  ; Relation (id2,cid2,mid2,"kAraNa_xyowakaH",id3,cid3,mid3,"57.12",d23)
                  ]
		  else []
     | "wawaH" -> if not (id2 = 1 && yawaH_pos.val = 50) then 
                   [ Relation (id3,cid3,mid3,"kArya_kAraNa_BAvaH",id1,cid1,mid1,"57.13",d13)
                   ; Relation (id2,cid2,mid2,"kArya_xyowakaH",id3,cid3,mid3,"57.14",d23)
                   ]
                  else []
     | "yaxA"
     | "waxA" -> [ Relation (id3,cid3,mid3,"samAnakAlaH",id1,cid1,mid1,"57.15",d13)]
     | _ -> []
     ]
;
...
value dis_rel_pair2 m1 id2 cid2 mid2 id3 cid3 mid3 word2 tense3 = match m1 with
    ...
    | Kqw (id1,cid1,mid1,_,_,_,_,kqw1,_,_,_,_,_,_,viB1,_,_) ->
...
value rl_wif_kriyA_kriyA m1 m2 m3 text_type = match m2 with
     [ Avy (id2,cid2,mid2,_,word2,_,_,_) -> 
        if    word2 = "yaxyapi" || word2 = "waWApi" || word2 = "aWApi" 
           || word2 = "cexapi" || word2 = "sannapi" || word2 = "warhyapi" 
	   ...
	   dis_rel_pair2 m1 id2 cid2 mid2 id3 cid3 mid3 word2 lat3
        | Kqw (id3,cid3,mid3,_,_,_,_,kqw3,_,_,_,_,_,_,_,_,_) ->
...
value rlca_samucciwa m1 m2 m3 text_type = match m2 with
     [ Avy (id2,cid2,mid2,_,word2,_,_,_) -> 
        if word2 = "ca" || word2 = "cEva" || word2 = "aWa" || word2="waWA"  (* agaswyaM ca agaswya-BrAwaraM waWA xaxarSa ha -- Sanskshepa Ramayanam 41-42 *) || word2 = "api"
        then match m3 with
        ...
        | Avykqw (id3,cid3,mid3,_,_,_,_,_,_,kqw_prawyaya3,_,_) -> match m1 with
             [ Avykqw (id1,cid1,mid1,_,_,_,_,_,_,kqw_prawyaya1,_,_) ->
                 if kqw_prawyaya1=kqw_prawyaya3
                 then mark_sup_samucchiwa id1 id2 id3 cid1 cid2 cid3 mid1 mid2 mid3 0 0 0 0 word2 "58.5" "58.6"
                 else []
             | _ -> []
             ]
        | Sup(id3,cid3,mid3,_,rt3,_,_,_,viBakwiH3,vacanam3,_) 
        | WaxXiwa (id3,cid3,mid3,_,rt3,_,_,_,_,viBakwiH3,vacanam3,_) -> 
              match m1 with
              [ Sup(id1,cid1,mid1,word1,rt1,_,_,_,viBakwiH1,vacanam1,_) 
              | Kqw (id1,cid1,mid1,word1,rt1,_,_,_,_,_,_,_,_,_,viBakwiH1,vacanam1,_) 
        ...
        | Kqw (id3,cid3,mid3,rt3,word3,_,_,kqw3,_,_,_,_,_,lifgam3,viBakwiH3,vacanam3,_) ->
              match m1 with
              [ Kqw (id1,cid1,mid1,_,_,_,_,kqw1,_,_,_,_,_,lifgam1,viBakwiH1,vacanam1,_) ->
                 if kqw3=kqw1 && lifgam3 = lifgam1 (* condition for lifgam is added to avoid joining of wuRyanwi with kaWayanwaH; the first one is neuter and the second one masc *)
              ...
              (* samucciwa of a kqw with sup, we need examples. In the case of niwyaM wuRyanwi ca, it would join niwyam with wuRyanwi, which is wrong.  The condition for kriyA viSeRaNa is added to account for this.*)
	      | Sup(id1,cid1,mid1,word1,rt1,_,_,_,viBakwiH1,vacanam1,_)
              | WaxXiwa (id1,cid1,mid1,word1,rt1,_,_,_,_,viBakwiH1,vacanam1,_) ->
                  if  (((member_of (word1^" "^string_of_int(viBakwiH1)) kriyAviSeRaNas) && member_of (word3^" "^string_of_int(viBakwiH3)) kriyAviSeRaNas)
                     || (not (member_of (word3^" "^string_of_int(viBakwiH3)) kriyAviSeRaNas) && not (member_of (word1^" "^string_of_int(viBakwiH1)) kriyAviSeRaNas)))
                  && no_boundary_crossing_with_iwi id1 id3 text_type
		  then
        ...
        | Avy (id3,cid3,mid3,_,word3,_,_,_) -> 
		 ...
		 if not (word1 = "na") && (id1-id3) < 5 && (id1 - id3) > -5 then (* the two avys are not far away *)
...
(* ... gacCawi pATam vA samyak paTawi / gacCawi wiRTawi vA *)
        ...
        | Avykqw (id3,cid3,mid3,_,_,_,_,_,_,kqw3,_,_) ->
             match m1 with
             [ Avykqw (id1,cid1,mid1,_,_,_,_,_,_,kqw1,_,_) ->
                 if kqw1=kqw3
        ...
        | Kqw (id3,cid3,mid3,_,_,_,_,kqw3,_,_,_,_,_,_,viBakwiH3,vacanam3,_) ->
              match m1 with
              [ Kqw (id1,cid1,mid1,_,_,_,_,kqw1,_,_,_,_,_,_,viBakwiH1,vacanam1,_) ->
                 if kqw3=kqw1
...
value init_sentence_feature_variables morphs  = 
 ...
 (fun m -> match m with 
     [ Wif (id,cid,mid,word,rt,_,_,upasarga,_,_,_,_,_,_,_,_) -> 
             ...
             if (rt = "BU1") then aswi_pos.val := id  else ();
       ...
       | [ m1 :: r1 ] -> 
            ...
            | [ m2 :: r2 ] -> 
                     ...
                     | [m3 :: r3 ] -> 
                               ...
                               let relations_m1_m2_m3 = 
                               List.fold_left collate acc2 all_compound_3_rules where
                               collate rls rule = match rule m1 m2 m3 text_type with
                                 [ [] -> rls
                                 | r -> List2.union r rls
                                 ] in loop3 (List2.union relations_m1_m2_m3 acc3) r3
    ...
    | [Relation (b1,c1,d1,rel1,f1,g1,h1,rl1,dist1) :: s] ->   (* do { print_sint count;  print_sint a1; print_sint b1; print_string c1; print_sint d1; print_string "\n"; *)
                      if b=b1 then 
                        if dist = dist1 then  (* do { print_string "distance same added\n"; *)
                           ...
                           (* } *)
                         else if (   rel1="viSeRaNam" 
                                  || rel1 = "upamAnam"
                                  || rel1 = "viXeya_viSeRaNam" 
                                  || rel1 = "karwA"
                                  || rel1 = "karwA_be_verbs" 
                                  || rel1="aBexaH" 
                                  || rel1 = "samAsaH") then  (* do { print_string "viSeRaNam found\n"; *) (* karwA is added, since typically in prose form karwA is in the beginning, far away from the verb *)
                                let acc1 = List.append acc [Relation (b1,c1,d1,rel1,f1,g1,h1,rl1,dist1)] in 
                                    loop acc1 b1 c1 d1 rel1 f1 g1 h1 dist1 count s
   (* It is possible that RaRTI sambanXaH with immediate next/previous words do not yield the correct answer;
E.G wri-lokajFaH vAlmIkeH nAraxaH vacaH ... here vAlmIkeH can get potentially connected to the previous and the following. But the correct relation is with vacaH. Till we do not know how to stop this, we will allow upto 3 conenctions *)
